	...
	service:{
		...
		services:[
			...
			},
			{
				...
				body:[
					"commodo, cupidatat messenger bag mumblecore yr velit. Skateboard fixie mlkshk, typewriter umami eiusmod tempor odio nostrud hoodie fanny pack irony",
					"dreamcatcher do selvage direct trade lo-fi mustache pork belly. Art party sapiente semiotics nostrud artisan, nisi american apparel sint photo booth brooklyn. Nostrud delectus exercitation, +1 messenger bag artisan 8-bit cillum labore."
					],
				bulletpoints:[
					"selvage direct",
					"lo-fi mustache",
					"tattooed, DIY cupidatat aesthetic",
					"iphone park"
				]
			...
			{
				title:"Formula 3: sartorial reprehenderit art party in tumblr",
				body:[
					"8-bit sriracha. Cupidatat banh mi fixie, vegan odd future velit squid vice veniam jean shorts non pour-over four loko wayfarers.",
					"Echo park nihil PBR, gastropub thundercats placeat four loko dolore nesciunt. Seitan portland jean shorts mlkshk esse exercitation Bushwick"
					],
				bulletpoints:[
					"Messenger bag butcher",
					"Officia laborum DIY",
					"over four loko wayfarers",
